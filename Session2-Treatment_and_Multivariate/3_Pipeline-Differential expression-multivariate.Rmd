---
title: 'Session 2 | Part 2 : Gene expression analysis, multivariate experiments'
...
>Additionally, you could also include a fold-change threshold to select DE genes. For instance, we could select genes whose expression change at least 1.5 times at any time point, with respect to time 0.
...
As we did in Session 1, now, we will estimate the dispersion in three steps: a common dispersion first, then a trended dispersion and finally a gene specific dispersion:
