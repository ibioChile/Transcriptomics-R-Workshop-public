...
Start importing counts table and metadata associated to the samples (previously downloaded from [Data](https://github.com/ibioChile/Transcriptomics-R-Workshop/tree/master/Session1-Temporal_Analysis/Data) folder).
...
The tree could be "cutted" at a desired level to obtain clusters. If we cut at 35%, we will produce 5 clusters
...
Now, you would want to know what functions are represented on this selected genes. This will be explained on session 2.
