...
> In general, if you receive a "margins too large" message, try to expand the RStudio plot panel and try again.  

> Another solution for large figures is to execute a **x11()** command before each plot. This will activate a new window where the next plot will be diplayed.  
